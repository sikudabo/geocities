...
function NotificationsComponent(props) {
    ...
    useEffect(() => {
        if(props.mainUser === null) {
            ...
            return axios({
                method: 'GET',
                url: `http://10.162.93.179:3001/api/grab/user/${props.mainUser.uniqueUserId}`
            }).then(response => {
    ...
    function deleteNotification(uniqueNotificationId, link) {
        ...
        return axios({
            method: 'POST',
            url: 'http://10.162.93.179:3001/api/delete/notification',
            data: data,
            headers: {
    ...
    function acceptRejectFollow(followerUsername, followerUniqueUserId, uniqueNotificationId, accept) {
        ...
        return axios({
            method: 'POST',
            url: 'http://10.162.93.179:3001/api/follow/request/choice',
            data: data,
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    function acceptRejectJoinRequest(username, uniqueUserId, community, uniqueNotificationId, acceptReject) {
        ...
        return axios({
            method: 'POST',
            url: 'http://10.162.93.179:3001/api/accept/reject/community/join',
            data: data,
            headers: {
                'Content-Type': 'application/json',
            },
                                    ...
                                    {notification.type === 'post comment' &&
                                        ...
                                        >
                                            ...
                                            >
                                                <ListItemAvatar>
                                                    <Avatar 
                                                        src={`http://10.162.93.179:3001/api/get/avatar/by/id/${notification.uniqueSenderId}`}
                                    ...
                                    {notification.type === 'join accepted' &&
                                        ...
                                        >
                                            ...
                                            >
                                                <ListItemAvatar>
                                                    <Avatar 
                                                        src={`http://10.162.93.179:3001/api/get/avatar/by/community/name/${notification.community}`}
                                                        alt={`${notification.sender}`}
                                                        title={`${notification.sender}`}
                                                    />
                                                </ListItemAvatar>
