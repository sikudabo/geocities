...
function Community(props) {
    ...
    function updateTopics() {
        ...
        if(topics.length < 1) {
            ...
            return axios({
                method: 'POST',
                url: 'https://www.geocities.cce/api/update/community/topics',
                data: data,
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    function blockUser(uniqueUserId, username) {
        ...
        if(uniqueUserId === community.moderator.uniqueUserId) {
            ...
            return axios({
                method: 'POST',
                url: 'https://www.geocities.cce/api/block/community/user',
                data: data,
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    function unBlockUser(uniqueUserId, username) {
        ...
        return axios({
            method: 'POST',
            url: 'https://www.geocities.cce/api/unblock/community/user',
            data: data,
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    function deleteRule(rule) {
        ...
        return axios({
            method: 'POST',
            url: 'https://www.geocities.cce/api/delete/community/rule',
            data: data,
            headers: {
                'Content-Type': 'application/json',
            }
