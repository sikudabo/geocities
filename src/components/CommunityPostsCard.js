...
function GeoUserPostsCard(props) {
    ...
    function handleLike() {
        ...
        return axios({
            method: 'POST',
            url: 'http://10.162.93.179:3001/api/handle/geo/post/like',
            data: data,
            headers: {
    ...
    async function sendComment() {
        ...
        if(!formValid) {
            ...
            return axios({
                method: 'POST',
                url: 'http://10.162.93.179:3001/api/add/geo/comment',
                data: data,
                headers: {
                    'Content-Type': 'application/json',
                }
    ...
    function handleCommentLike(uniqueCommentId, uniqueCommenterId, isLiked) {
        ...
        return axios({
            method: 'POST',
            url: 'http://10.162.93.179:3001/api/handle/geo/comment/like',
            data: data,
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    return (
        ...
        >
            <CardHeader 
                ...
                avatar={
                    <Avatar 
                        src={`http://10.162.93.179:3001/api/get/avatar/by/community/name/${props.post.community}`}
            ...
            <div>
                {props.post.type === 'photo' &&
                    <CardMedia 
                        ...
                        image={`http://10.162.93.179:3001/api/get-photo/${props.post.src}`}
